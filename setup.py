...
#
#     from parser330 import metadata
#
# However, when we do this, we also import `parser330/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'parser330_cli = parser330.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'parser330_gui = parser330.gui:entry_point'
        # ]
    }
)
